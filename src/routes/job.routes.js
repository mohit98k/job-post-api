...
import { createJob,getJob,getJobs,getRecommendedJob,getApplications,getLatestJobs } from '../controllers/job.controller.js';
...
router.get("/getLatestJobs",verifyJWT,isUser,getLatestJobs);
